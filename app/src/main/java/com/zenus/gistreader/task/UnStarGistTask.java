...
public class UnStarGistTask extends AsyncTask<String, String, Void> {
    private StarGistListener mStateListener;
    private boolean callbackReceived;
    private static final String t = UnStarGistTask.class.getName();
    private String[] msg = null;

    public UnStarGistTask(){
    ...
    protected Void doInBackground(String... values) {
        ...
        GistApplication.getInstance().getApiController().unStarGist(gistId, new Callback() {
            @Override
            ...
            public Object after(Object... params) {
                ...
                new GistController().editGistStarringStatus(gistId, false);
            ...
            public void error(Object... params) {
                try {
                    if (params[0] instanceof NoConnectionError) {
                        ...
                        UnStarGistTask.this.msg = new String[]{GistApplication.getContext().getString(R.string.no_connection_to_host)};
                    } else {
                        UnStarGistTask.this.msg = new String[]{GistApplication.getContext().getString(R.string.server_error)};
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    UnStarGistTask.this.msg = new String[]{e.getMessage()};
                }
                new CommandController().addCommand(gistId, Commands.UNSTAR_GIST);
                callbackReceived = true;
            }
        });
